...
<html lang="en">
    ...
    <body>
        ...
        <footer>
            ...
            <div class="row">
                <p class="security-seal"><span id="siteseal"><script async type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=2Agi8UYfANmrQHX3X6CN3e4pKZcDEj2fLKWZ6QNHg4ISgM9EJHAYQYpRCfmf"></script></span></p>
                <p>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-89684778-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-89684778-2');
    </script>
